<nav class="navbar navbar-default" role="navigation">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo site_url('admin'); ?>">報修系統</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        -->
        <li><a href="<?php echo site_url('admin/auth'); ?>">管理者</a></li>
        <li class="dropdown">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        -->
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">管理者你好 <span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
            <li><a href="<?php echo site_url(); ?>">切換回首頁</a></li>
            <li><a href="<?php echo base_url('auth/logout'); ?>">登出</a></li>
            <!--
